...
4.2.3 利用斷詞系統將，將資料中的文字斷詞，並找出關鍵字<br/>
...
4.2.6 利用找出的關聯，進而推論新的資料應該對應的分配機關<br/>
